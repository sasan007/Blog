...
namespace BlogManagement.Endpoints.API.Middleware
{
    public class LoggingMiddleware
    {
        const string MessageTemplate ="HTTP {RequestMethod} {Body} {RequestPath} responded {StatusCode} in {Elapsed:0.0000} ms";
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            try
            {
                ...
                log.Write(level, MessageTemplate, httpContext.Request.Method, requestBodyPayload, httpContext.Request.Path, statusCode, sw.Elapsed.TotalMilliseconds);
            }
